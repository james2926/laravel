            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-footer mt-5">
                        ...
                        <button type="button" onclick="sendMessage()" class="btn btn-success mt-3" id="sendButton">Send</button>
                        <input type="file" id="imageUpload" accept="image/*" style="display:none;">
                        <button type="button" onclick="document.getElementById('imageUpload').click();" class="btn btn-info mt-3">Upload Image</button>
                    </div>
                </div>
            </div>
        </div>
